# Generated by Django 4.2.30 on 2026-07-06 21:11
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('db', '0122_project_is_epic_enabled'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('property_type', models.CharField(choices=[('TEXT', 'Text'), ('DECIMAL', 'Decimal'), ('OPTION', 'Option'), ('BOOLEAN', 'Boolean'), ('DATETIME', 'Datetime'), ('RELATION', 'Relation'), ('URL', 'URL'), ('EMAIL', 'Email'), ('FILE', 'File')], max_length=20)),
                ('relation_type', models.CharField(blank=True, choices=[('ISSUE', 'Issue'), ('MEMBER', 'Member')], max_length=20, null=True)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('value_decimal', models.DecimalField(blank=True, decimal_places=8, max_digits=25, null=True)),
        ...
        migrations.AddConstraint(
            ...
            constraint=models.UniqueConstraint(condition=models.Q(('deleted_at__isnull', True)), fields=('property', 'name'), name='issue_property_option_unique_name_when_deleted_at_null'),
        ),
    ]
